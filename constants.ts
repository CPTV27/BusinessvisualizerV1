...
export const INITIAL_ENTITIES: BusinessEntity[] = [
  // --- FOUNDATION LAYER (NATCHEZ HUB) ---
  {
    ...
    description: "6-suite boutique inn in an 1892 guesthouse. Thematic tribute to Delta musical heritage. Cultural premium pricing ($220-$249/night).",
    kpi: "Blended ADR",
    kpiValue: "$235",
    ...
    gaps: [
      {
        id: 'g_inn_1',
        description: "Seasonal yield management strategy not formalized. Off-peak (Dec-Feb) rates need 'Reset' and 'Romance' packages.",
        priority: 'HIGH',
  ...
  },
  {
    ...
    description: "50-cap intimate live music venue. ASPV target $79.22. Beverage-driven model (50% COGS). Fixed monthly burn ~$27,817. Programming: Blue Monday, Blues School, Headline Fri, Sat Double, Gospel & Gravy.",
    kpi: "Annual Visits",
    kpiValue: "32,000",
    ...
    gaps: [
      ...
      {
        id: 'g_heg_2',
        description: "Door split negotiation: need 50/50 or 70/30 model vs 100% artist standard.",
        priority: 'HIGH',
        status: GapStatus.OPEN,
      },
      {
        id: 'g_heg_3',
        description: "Utilization Trap: calendar under-booked, overhead absorption rate plummets below 15 shows/month.",
        priority: 'MEDIUM',
        status: GapStatus.OPEN,
      }
    ],
  ...
  // --- ROOM CATEGORIES: THE 6 NAMED SUITES ---
  {
    id: 'e_room_1',
    ...
    layer: ServiceLayer.BUSINESS,
    description: "Flagship suite named for the Father of Modern Chicago Blues. Original art, curated antiques, Delta blues heritage immersion.",
    kpi: "Nightly Rate",
    kpiValue: "$249",
  ...
  },
  {
    ...
    type: EntityType.ROOM_CATEGORY,
    layer: ServiceLayer.BUSINESS,
    description: "Crossroads mythology. Deep blues history woven into every detail. $220-$249/night.",
    kpi: "Nightly Rate",
    kpiValue: "$239",
  ...
  {
    id: 'e_room_3',
    name: "B.B. King Grand Suite",
    location: "The Big Muddy Inn",
    type: EntityType.ROOM_CATEGORY,
    layer: ServiceLayer.BUSINESS,
    description: "The property's grand suite. Private entrance, porch overlooking Stanton Hall, 75\" Sony Smart TV. Ideal for long-stay and high-net-worth travelers.",
    kpi: "Nightly Rate",
    kpiValue: "$249+",
    ...
    gaps: [
      {
        id: 'g_room_3',
        description: "Concierge experience design for VIP arrival at private entrance.",
        priority: 'HIGH',
        status: GapStatus.OPEN,
      }
    ],
  ...
  },
  {
    ...
    type: EntityType.ROOM_CATEGORY,
    layer: ServiceLayer.BUSINESS,
    description: "Green-glazed walls, high-quality linens. Boogie blues atmosphere. $249/night cultural premium.",
    kpi: "Nightly Rate",
    kpiValue: "$249",
  ...
  },
  {
    ...
    type: EntityType.ROOM_CATEGORY,
    layer: ServiceLayer.BUSINESS,
    description: "London-forward flair with Beatles memorabilia. Acknowledges the Delta blues influence on British rock. International market targeting.",
    kpi: "Nightly Rate",
    kpiValue: "$220+",
    imageUrl: "https://images.unsplash.com/photo-1560185893-a55cbc8c57e8?auto=format&fit=crop&q=80&w=1600",
    gaps: [],
  ...
  },
  {
    ...
    type: EntityType.ROOM_CATEGORY,
    layer: ServiceLayer.BUSINESS,
    description: "\"Jewel box\" queen room. Compact luxury with British rock heritage. Entry-level suite at $220/night.",
    kpi: "Nightly Rate",
    kpiValue: "$220",
    imageUrl: "https://images.unsplash.com/photo-1505577058444-a3dab90d4253?auto=format&fit=crop&q=80&w=1600",
    gaps: [],
    coordinates: { x: 47, y: 80 }
  },
  ...
  {
    id: 'e3',
    name: "Ari Teitel / Aslin Brand",
    location: "New Orleans / Global",
    type: EntityType.BRAND,
    layer: ServiceLayer.NETWORK,
    description: "Grammy-nominated guitarist, North Star talent. Collaborations: Robert Randolph, PJ Morton. Creative director IP. Justifies $120 VIP tier. Sync-ready catalog potential.",
    kpi: "VIP Tier Revenue",
    kpiValue: "$120/seat",
    imageUrl: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?auto=format&fit=crop&q=80&w=1600",
    gaps: [
      {
        id: 'g4',
        description: "Sync prep needed: master/publishing rights clearance, instrumental versions, metadata tagging for all tracks.",
        priority: 'HIGH',
        status: GapStatus.OPEN,
      },
      {
        id: 'g4b',
        description: "30-day unavailability risk: local residency fallback acts not curated yet.",
        priority: 'HIGH',
        status: GapStatus.OPEN,
      }
    ],
